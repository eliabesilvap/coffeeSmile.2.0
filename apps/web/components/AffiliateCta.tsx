...
export function AffiliateCta({ url, title, buttonText, imageUrl }: AffiliateCtaProps) {
  return (
    <section className="rounded-3xl border border-brand-100 bg-white px-6 py-8 shadow-sm">
      <div className="grid gap-6 md:grid-cols-[minmax(0,180px)_minmax(0,1fr)]">
        ...
        <div className="flex flex-col justify-center gap-4">
          ...
          <p className="font-display text-xl font-semibold leading-snug text-brand-900">
            {title}
          </p>
          <a
            href={url}
